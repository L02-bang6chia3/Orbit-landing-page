          ...
          return (
            <div
              ...
              className={`relative border ${
                hasEvents ? 'border-cosmic/30 bg-cosmic/10' : 'border-white/10 bg-space/50'
              } p-1`}
            >
        ...
        {[
          ...
          >
            ...
            <div className="flex-1">
              ...
              {item.habit && <div className="text-xs text-mint/80">Auto-scheduled habit</div>}
            </div>
            {item.habit && <div className={`h-2 w-2 bg-${item.color} rounded-full`}></div>}
          </motion.div>
        ))}
      </div>
    </div>
          ...
          <RevealItem>
            <GlowCard className="p-6 sm:p-8 h-full flex flex-col">
              ...
              <p className="text-white/60 mb-6">
                Building habits is hard when you don't know <em>when</em> to do them. Without a
                central gravity, your tasks just drift away.
              </p>
          ...
          <RevealItem delay={0.1}>
            <GlowCard className="p-6 sm:p-8 h-full flex flex-col">
              ...
              <p className="text-white/60 mb-6">
                ...
                automatically reads your busy/free data, calculates the perfect time slots, and
                syncs your habits seamlessly.
              </p>
